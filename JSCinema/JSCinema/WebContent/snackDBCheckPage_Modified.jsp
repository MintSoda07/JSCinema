...
<body>
	...
	Connection con = null;
		...
		String original_path = multi.getParameter("original_path");
		...
		File f = new File(file_path + original_path);
		if (f.exists()){
			f.delete();
		}else{
